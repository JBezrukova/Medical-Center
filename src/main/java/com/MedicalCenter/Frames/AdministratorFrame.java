...
import com.MedicalCenter.DAO.AdministratorDAO;
...
public class AdministratorFrame extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        if (!jTextField1.getText().isEmpty() && !jTextField2.getText().isEmpty()) {
            Administrator administrator = AdministratorDAO.getDAO().getAdminByLogin(jTextField1.getText());
            if (administrator != null) {
                if (administrator.getPassword().equals(jTextField2.getText())) {
                    AdminPanel.getInstance(administrator).setVisible(true);
