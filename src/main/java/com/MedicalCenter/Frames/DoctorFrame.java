...
public class DoctorFrame extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        if (!jTextField1.getText().isEmpty() && !jTextField2.getText().isEmpty()) {
            Doctor doctor = DoctorDAO.getDAO().getDocByLogin(jTextField1.getText());
            if (doctor != null) {
                if (doctor.getPassword().equals(jTextField2.getText())) {
                    DoctorPanel.getInstance(doctor).setVisible(true);
